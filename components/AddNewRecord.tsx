...
const AddNewRecord = () => {
  ...
  return (
    <div className='bg-gray-100 flex items-center justify-center'>
      <div className='bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 shadow-lg rounded-lg p-8 w-full'>
          ...
          <div className='flex flex-col md:flex-row md:space-x-4'>
            ...
            <div className='flex-1'>
              ...
              <select
                ...
                className='block w-full text-white border border-white rounded-md shadow-sm px-4 py-2'
                required
              >
            ...
            <div className='flex-1'>
              ...
              <input
                ...
                name='date'
                id='date'
                className='block w-full border border-white text-white rounded-md shadow-sm px-4 py-2'
